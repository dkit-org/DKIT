...
import org.dkit.fxclient.component.dock.DockNode;
import org.dkit.fxclient.component.dock.DockPane;
import org.dkit.fxclient.component.dock.DockPos;
...
public class DockFX extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    tabs.getTabs().addAll(new Tab("Tab 1", new VBox(new TextField("hello world"))), new Tab("Tab 2"), new Tab("Tab 3"));
    ...
    Image dockImage = new Image(DockFX.class.getResource("/img/docknode.png").toExternalForm());

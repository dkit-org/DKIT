...
package org.dkit.fxclient.component.dock;
...
public class DockPane extends StackPane implements EventHandler<DockEvent> {
  ...
  public DockPane() {
    ...
    // 12 is the cumulative offset of the stroke dash array in the dock.css style sheet
  ...
  public final static String getDefaultUserAgentStyleheet() {
    return DockPane.class.getResource("/styles/dock.css").toExternalForm();
  }
  ...
  public final static void initializeDefaultUserAgentStylesheet() {
    StyleManager.getInstance()
        .addUserAgentStylesheet(DockPane.class.getResource("/styles/dock.css").toExternalForm());
  }
